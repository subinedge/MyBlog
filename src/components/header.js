    ...
    <header className = {headerStyles.navBar}>
      <nav className={headerStyles.navBar__navigation}>
        ...
        <div className={headerStyles.navBar__navigationItems}>
            <ul>
              <li><Link to="/" className={headerStyles.item} activeClassName={headerStyles.activeNavItem}>Home</Link></li>
              <li><Link to="/blog" className={headerStyles.item} activeClassName={headerStyles.activeNavItem}>Blog</Link></li>
              <li><Link to="/about" className={headerStyles.item} activeClassName={headerStyles.activeNavItem}>About</Link></li>
              <li><Link to="/contact" className={headerStyles.item} activeClassName={headerStyles.activeNavItem}>Contact</Link></li>
            </ul>
        </div>
